 ...
 * @author Datos
 */
public class NewGUI2 extends javax.swing.JFrame {

    /**
     * Creates new form NewGUI2
     */
    public NewGUI2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/upeu/sysventas/clientes.png"))); // NOI18N
        jButton1.setText("CLIENTES");

        jButton2.setBackground(new java.awt.Color(204, 0, 255));
        jButton2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/upeu/sysventas/clientes.png"))); // NOI18N
        jButton2.setText("CLIENTES");

        jButton3.setBackground(new java.awt.Color(204, 0, 255));
        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/upeu/sysventas/clientes.png"))); // NOI18N
        jButton3.setText("CLIENTES");

        jButton4.setBackground(new java.awt.Color(204, 0, 255));
        jButton4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton4.setForeground(new java.awt.Color(255, 255, 255));
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/upeu/sysventas/clientes.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
